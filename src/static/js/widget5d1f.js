...
(function (win, doc, nav, params, namespace, undefined) {
    ...
    var initWidget = function () {
        util.loadScript('https://yastatic.net/s3/translate/v21.14.7/js/tr_page.js', wrapper, function () {
                ...
                function (responseText) {
                    ...
                    new Widget({
                        ...
                        translator: new namespace.PageTranslator({
                            srv: 'tr-url-widget',
                            sid: 'cd47d15b.612bd646.ecbba33d.74722d75726c2d776964676574',
...
})(this, this.document, this.navigator, {"pageLang":"en","widgetId":"ytWidget","autoMode":"true","widgetTheme":"dark"}, this.yt = this.yt || {});
